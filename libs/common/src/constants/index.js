...
// ─────────────────────────────────────────────────────────────────────────────
// ── Version ───────────────────────────────────────────────────────────────────
export const TITAN_VERSION = '0.1.1';
export const TITAN_API_VERSION = 'v1';
export const TITAN_MIN_LICENSE_VERSION = '0.1.0';
...
// ── Job settings ──────────────────────────────────────────────────────────────
export const DEFAULT_JOB_PRIORITY = 'normal';
...
// ── Update channels ───────────────────────────────────────────────────────────
export const UPDATE_CHANNELS = ['stable', 'beta', 'canary'];
// ── TruePath defaults ─────────────────────────────────────────────────────────
...
export const NESTING_ROTATIONS = [0, 90, 180, 270];
// ── SyncTrace ─────────────────────────────────────────────────────────────────
